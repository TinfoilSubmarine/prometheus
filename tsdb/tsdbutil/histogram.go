...
func GenerateTestHistograms(n int64) (r []*histogram.Histogram) {
	for i := int64(0); i < n; i++ {
...
func GenerateTestHistogramWithHint(n int64, hint histogram.CounterResetHint) *histogram.Histogram {
...
func GenerateTestGaugeHistograms(n int64) (r []*histogram.Histogram) {
	for x := int64(0); x < n; x++ {
...
func GenerateTestFloatHistograms(n int64) (r []*histogram.FloatHistogram) {
	for i := int64(0); i < n; i++ {
...
func GenerateTestGaugeFloatHistograms(n int64) (r []*histogram.FloatHistogram) {
	for x := int64(0); x < n; x++ {
		i := int64(math.Sin(float64(x))*100) + 100
